...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="card w-100 shadow-lg">
        ...
        <a class="btn btn-secondary mt-3" role="button" href="staff.php">Go Back To Staff</a>
            <h3 class="text-center mt-4 mb-4 text-dark">Update Staff</h3>
            ...
            <?php
                ...
                <h4 class="mb-3 mt-5">Name of Staff</h4>
                ...
                <div class="d-flex justify-content-center">
                    <button name="btn-create-staff" type="submit" class="btn btn-dark w-25 py-2 fs-4 mb-4 rounded-2" style="justify-content: center !important;"

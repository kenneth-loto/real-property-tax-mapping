...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="card w-100 shadow-lg">
        <div class="card-body">
        <a class="btn btn-secondary mt-3" role="button" href="staff.php">Go Back To Admin</a>
            <h3 class="text-center mt-4 mb-4 text-dark">New Admin</h3>
            ...
            <?php
                ...
                <h4 class="fw-bold mb-2">Name of Admin</h4>
                ...
                <div class="d-flex justify-content-center">
                    <button name="btn-add-admin" type="submit" class="btn btn-dark w-25 py-2 fs-4 mb-4 rounded-2" style="justify-content: center !important;"

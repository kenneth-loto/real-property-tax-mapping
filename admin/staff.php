...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4 text-dark">Staff</h5>
            <a class="btn btn-secondary fw-bold mb-3 text-light" role="button" href="add_staff.php">Add Staff</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="table">
                            ...
                            <tbody class="text-dark">
                                ...
                                $allStaff = $function->getAllStaff(); // Fetch disease data
                                        ...
                                        <tr class="text-align-left">
                                            ...
                                            <td>
                                                <div  class="d-flex justify-content-center">
                                                    <a class="btn btn-warning me-2" href="update_staff.php?id=<?= $id; ?>" title="Update">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action='../navigate.php' method='post' style='display: inline;'>
                                                        <input type='hidden' name='id' value='<?= $id; ?>'>
                                                        <button class='btn btn-danger' name='btn-delete-staff' type='submit' onclick="return confirm('Are you sure you want to delete this municipality user?');" title='Delete'>

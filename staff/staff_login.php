          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <button name="btn-login-staff" type="submit" class="btn btn-dark w-100 py-8 fs-4 rounded-2">Sign In</button>

                <!--
                <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">New to <strong>RPTMTCS</strong>?</p>
                    <a class="text-primary fw-bold ms-2" href="staff_create_account.php">Create an account</a>
                </div>
                -->

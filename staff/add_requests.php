            ...
            <form method="post" action="../navigate.php" enctype="multipart/form-data">
                <div class="row text-dark">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="number" class="form-control" name="phone_number" value="<?php echo isset($_SESSION['form_data']['phone_number']) ? htmlspecialchars($_SESSION['form_data']['phone_number']) : ''; ?>" placeholder="e.g. 09123456789 (11 digits)" required>
                    </div>
                </div>
                ...
                <div class="row text-dark">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" class="form-control" name="area" value="<?php echo isset($_SESSION['form_data']['area']) ? htmlspecialchars($_SESSION['form_data']['area']) : ''; ?>" placeholder="e.g. 1518.56 sqm" required>
                    </div>
                    <div class="col-md-4 mb-4">
                        <label for="market_value"><strong>Market Value <span class="text-danger">*</span></strong></label>
                        <input type="text" class="form-control" id="market_value" name="market_value" value="<?php echo isset($_SESSION['form_data']['market_value']) ? htmlspecialchars($_SESSION['form_data']['market_value']) : ''; ?>" placeholder="e.g. 400,899.00" required oninput="computeTax()">
                    </div>
                    <div class="col-md-4 mb-4">
                ...
                <div class="row text-dark justify-content-center">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" id="assessed_value" name="assessed_value" value="<?php echo isset($_SESSION['form_data']['assessed_value']) ? htmlspecialchars($_SESSION['form_data']['assessed_value']) : ''; ?>" placeholder="999.00" required oninput="computeTax()">
                    </div>
                </div>
                ...
                <div class="row text-dark">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" class="form-control" id="sef" name="sef" value="<?php echo isset($_SESSION['form_data']['sef']) ? htmlspecialchars($_SESSION['form_data']['sef']) : ''; ?>" placeholder="Auto generated" readonly>
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label" for="basic_tax"><strong>Basic Tax (1%) <span class="text-danger">*</span></strong></label>
                        <input type="text" class="form-control" id="basic_tax" name="basic_tax" value="<?php echo isset($_SESSION['form_data']['basic_tax']) ? htmlspecialchars($_SESSION['form_data']['basic_tax']) : ''; ?>" placeholder="Auto generated" readonly>
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label" for="tax_due"><strong>Total Tax Due <span class="text-danger">*</span></strong></label>
                        <input type="text" class="form-control" id="tax_due" name="tax_due" value="<?php echo isset($_SESSION['form_data']['tax_due']) ? htmlspecialchars($_SESSION['form_data']['tax_due']) : ''; ?>" placeholder="Auto generated" readonly>
                    </div>
                </div>
                ...
                <div class="row text-dark justify-content-center">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" id="staff_email" name="staff_email" value="<?php echo isset($_SESSION['form_data']['staff_email']) ? htmlspecialchars($_SESSION['form_data']['staff_email']) : ''; ?>" placeholder="e.g. example@gmail.com" required oninput="computeTax()">
                    </div>
                </div>

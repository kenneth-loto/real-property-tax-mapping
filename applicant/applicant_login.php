            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="fw-bold" href="forgot_password.php" style="font-size: 13px; color: #2c3e50;">Forgot Password?</a>
                </div>

                <button name="btn-login-applicant" type="submit" class="btn btn-dark w-100 py-8 fs-4 mb-4 rounded-2">Sign In</button>

                <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">New to <strong>RPTMTCS</strong>?</p>
                    <a class="fw-bold ms-2" style="color: #2c3e50" href="applicant_create_account.php">Create an account</a>
                </div>
                </form>
              </div>

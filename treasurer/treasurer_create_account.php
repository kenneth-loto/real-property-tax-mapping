              ...
              <div class="card-body">
                ...
                <form method="post" action="../navigate.php" class="mt-4" enctype="multipart/form-data">
                  ...
                  <div class="d-flex justify-content-center">
                    <button name="btn-create-treasurer" type="submit" class="btn btn-dark w-50 py-2 fs-4 mb-4 rounded-2" 
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <a class="text-primary fw-bold ms-2" href="treasurer_login.php">Sign In</a>
                  </div>
                </form>
              </div>
            </div>

    ...
    <aside class="left-sidebar">
      ...
      <div>
        ...
        <div class="text-center mt-2"> <!-- Centering div -->
            <h3 class="fw-semibold">TREASURER</h3>
        </div>
        <!-- Sidebar navigation-->
        <nav class="sidebar-nav scroll-sidebar">
          <ul id="sidebarnav">
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu text-light">Manage Transactions</span>
            </li>
            ...
            <li class="sidebar-item">
              <a class="btn sidebar-link" href="view_reports.php" aria-expanded="false">
                ...
                <span class="hide-menu fw-bold">View Reports</span>
              </a>
            </li>
